...
In your Laravel Conventions guide, you said to use modules pattern when you have > 100 models. So in this project I'm not use modules, just to keep it simple.
